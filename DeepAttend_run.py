        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    AA_notif.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
...
def trainimg():
    ...
    try:
        recognizer.save("/home/trident/DeepAttend/TrainingImageLabel/Trainer.yml")
    except Exception as e:
...
message = tk.Label(window, text="Welcome to DeepAttend!", fg = "black",
                   bg="SlateBlue4",  width=50,height=3, font=('times', 30, 'italic bold '))

message.place(x=160, y=20)

Notification = tk.Label(window, text="All things good", bg="Green", fg="white", width=15,
                      height=3, font=('times', 17, 'bold'))

lbl = tk.Label(window, text="Student's UID: ", width=20, height=2, fg="black", 
               bg="RoyalBlue4", font=('times', 15, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="turquoise3", fg="azure", font=('times', 25, ' bold '))
...
AP = tk.Button(window, text="Students Registered",command=admin_panel,fg="black"  ,bg="cyan"  ,width=25 ,
               height=1, activebackground = "blue violet" ,font=('times', 15, ' bold '))
AP.place(x=950, y=410)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="chartreuse"  ,width=20  
                    ,height=2, activebackground = "blue violet" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="chartreuse"  ,width=20  
                     ,height=2, activebackground = "blue violet" ,font=('times', 15, ' bold '))
...
quitWindow = tk.Button(window, text="Manual Attendance", command=manually_fill  ,fg="black"  ,bg="chartreuse" 
                       ,width=20  ,height=2, activebackground = "blue violet" ,font=('times', 15, ' bold '))
